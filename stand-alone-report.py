...
# set env
arcpy.env.workspace = r"C:\003-projects\004-ArcGIS\001-ResumeGDB\test.gdb" # the path of your gdb
# create temp fgdb
arcpy.CreateFileGDB_management(os.getcwd(), "tempStats.gdb")
path = "tempStats.gdb"
# create xlsx
outWorkbook = xlsxwriter.Workbook("stats.xlsx")
...
def fc_stats():
    ...
    for field in fieldsOutput:
        with arcpy.da.SearchCursor(output, [field.name]) as cursor:
            for row in cursor:
